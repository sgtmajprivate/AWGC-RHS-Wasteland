...
<br/>FAQ:
<br/>
<br/>Q. How do I earn money to buy gear?
<br/>A. There are many ways to earn money. You can capture zones on the map, and for every 10 minutes of having a zone captured you earn $1,000. You can also scavenge for vehicles and sell them at the traders, or you can find yourself a weapon in a vehicle and complete a smaller mission for valuable gear and sell it, and then tackle the more difficult missions.
<br/>
<br/>Q. Where are the vehicles?
<br/>A. Vehicles are randomly spawned throughout the map, if you find one, check its inventory for weapons and gear.
<br/>
<br/>Q. How can I locate my stuff on the map?
<br/>A. Once you obtain a GPS, you will then have the option to locate stuff you own on the map. Simply scroll through your player menu and select Locate stuff on map. Enter map view and you will see blue X's where all your items you own are located.
<br/>
...
<br/>A. You have a couple options here, First of all you will spawn with a Basic NVG monocular. At the GS, you can buy Combat Goggles with full screen NVG or upgrade your Monocular to NVG goggles.
<br/>
...
<br/>
<br/>Q. How to I build a base?
<br/>A. In order to build a base, you will need a BASE LOCKER found at the GS, General Store. Purchase one of these, find a safe location on the map and place the object. Once you have the object placed, you are granted access to the Base Manager Menu, from there purchase more objects from the GS, and away you go!
<br/>
<br/>Q. Where can I get a gun?
<br/>A. Weapons are found in one of three places, first in ammo crates that come as rewards from missions, inside and outside buildings, and second, in the gear section of the vehicles, which also randomly spawn around the map. The last place to find a gun would be at the gunshops GS located throughout the map. You can also find them on dead players whose bodies have not yet been looted.
"
]];
