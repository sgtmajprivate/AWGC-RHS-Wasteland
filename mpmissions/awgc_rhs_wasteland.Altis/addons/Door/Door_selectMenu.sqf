...
Door_Actions = 
{
	...
	[
		["<t color='#FFE496'><img image='client\icons\r3f_lock.paa'/> Open door menu</t>", Door_open, [cursorTarget], -97, false, false, "", PLAYER_CONDITION + " && " + ITEM_CONDITION + " && " + OBJECT_CONDITION]
	];
};
