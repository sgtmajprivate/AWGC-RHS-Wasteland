...
_setupObjects =
{
	...
	_convoyVeh = ["rhsusf_M1232_M2_usarmy_d","rhsusf_m1a1aimwd_usarmy","RHS_M2A3","rhsusf_m1a1aimwd_usarmy","rhsusf_m113_usarmy_MK19"];
...
_successExec =
{
	...
	for "_x" from 1 to 5 do
	{
		...
		_cash setVariable["cmoney",300000,true];
