...
[
	...
	["Box_IND_WpsSpecial_F", [-1.04126, 0.24707, 0], 286.415, {_this call randomCrateLoadOut;}],
	...
	["Box_East_WpsSpecial_F", [0.470947, -0.591309, 0], 85.8074, {_this call randomCrateLoadOut;}],
	...
	["RHS_M2StaticMG_D", [4.2, 6.6, 0], 0, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }],
	["RHS_M2StaticMG_D", [-4.5, 6.6, 0], 0, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }],
	["RHS_M2StaticMG_D", [-4.9, -6.5, 0], 180, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }],
	["RHS_M2StaticMG_D", [4.1, -6.5, 0], 180, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }]
]
