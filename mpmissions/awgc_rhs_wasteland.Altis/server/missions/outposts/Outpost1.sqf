...
[
	...
	["Box_IND_WpsSpecial_F", [-6.24817, 8.69141, 0], 180, {_this call randomCrateLoadOut;}],
	...
	["Box_East_WpsSpecial_F", [6.26294, -10.02422, 0], 180, {_this call randomCrateLoadOut;}],
	...
	["rhsgref_cdf_DSHKM", [6.15, 8.8, 0], 0, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }],
	["rhsgref_cdf_DSHKM", [-6.25, -9.8, 0], 180, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }],
	["rhsgref_cdf_DSHKM", [14.7, -0.95, 0], 90, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }],
	["rhsgref_cdf_DSHKM", [-16, -0.15, 0], 270, { if (random 1 < 0.5) exitWith { deleteVehicle _this }; [_this] call vehicleSetup }]
]
