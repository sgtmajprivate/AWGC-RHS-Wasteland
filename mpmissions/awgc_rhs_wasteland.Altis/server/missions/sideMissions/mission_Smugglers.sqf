...
_setupObjects =
{
	...
	_smugglerVeh = ["rhs_tigr_sts_vdv","rhsgref_cdf_reg_uaz_spg9","rhs_gaz66_zu23_vmf"] call BIS_fnc_selectRandom; 
...
_successExec =
{
	...
	_cashamountrandomizerb = [10000,15000,20000,25000,30000,35000,40000,45000,50000];
