...
_setupObjects =
{
	...
	_missionHintText = format ["A Sniper Nest has been spotted. Find them on SATCOM. Take them out! Be careful they are fully armed and dangerous!", sideMissionColor];
};
