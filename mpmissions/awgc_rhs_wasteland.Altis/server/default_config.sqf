...
A3W_combatAbortDelay = 3;         // If playerSaving = 1, delay in seconds for which to disable abort and respawn buttons after firing or being shot (0 = none)
...
A3W_mineSaving = 0;                // Save player-placed proximity mines between server restarts (0 = no, 1 = yes) - doesn't save dispensed/cluster mines
...
A3W_mainMissionTimeout = 1*60;    // Time in seconds that a Main Mission will run for, unless completed
A3W_sideMissionDelay = .1*60;       // Time in seconds between Side Missions
A3W_sideMissionTimeout = 1*60;    // Time in seconds that a Side Mission will run for, unless completed
A3W_moneyMissionDelay = .1*60;     // Time in seconds between Money Missions
A3W_moneyMissionTimeout = 1*60;   // Time in seconds that a Money Mission will run for, unless completed
