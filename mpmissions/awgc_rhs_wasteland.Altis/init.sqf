...
"RM_DISPLAYTEXT_PUBVAR" addPublicVariableEventHandler {(_this select 1) spawn BIS_fnc_dynamicText;};			// ServerRestartMessages
...
if (hasInterface || isServer) then
{
	...
	[] execVM "addons\FullScreenNVG\fullScreenNightVision.sqf";
